...
class Step03 extends Component {
  ...
  goStep01() {
    this.props.history.push("/report/new/step01")
  }
        ...
        <div className="contents animated fadeIn">
          <div className="wrap">
            ...
            <Card>
              ...
              <Row>
                <Col xs="12" lg="6">
                  <Button className="border-round step3-title-color float-right margin-bottom" size="lg"
                          onClick={this.goStep01.bind(this)}>
                    {t('btn.backtostep01')}
                  </Button>
                </Col>
                <Col xs="12" lg="6">
                  <Button className="border-round step3-title-color margin-bottom" size="lg"
